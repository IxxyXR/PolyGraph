...
namespace Mixture
{
	[System.Serializable, NodeMenuItem("Cone")]
	public class ConeNode : MixtureNode
	{
		[Output("Cone")]
		...
		protected override bool ProcessNode(CommandBuffer cmd)
		{
			...
			for (int i = 0; i < Sides; i++)
			{
				...
				Vector3 point = new Vector3(cos * Radius1, capHeight, sin * Radius1);
			...
			for (int i = 0; i < Sides; i++)
			{
				...
				float cos = Mathf.Cos(angle);
				float sin = Mathf.Sin(angle);
				Vector3 point = new Vector3(cos * Radius2, capHeight, sin * Radius2);
				Vector2 uv = new Vector2((cos * 0.5f) + 0.5f, (sin * 0.5f) + 0.5f);
				vertices[index] = point;
				normals[index] = normal;
				uvs[index] = uv;
			...
			if (Smooth)
			{
				for (int i = 0; i < Sides; i++)
				{
					...
					Vector3 point1 = new Vector3(cos * Radius1, 0, sin * Radius1);
					Vector3 point2 = new Vector3(cos * Radius2, capHeight, sin * Radius2);
			...
			else
			{
				for (int i = 0; i < Sides; i++)
				{
					...
					Vector3 point1 = new Vector3(cos * Radius1, 0, sin * Radius1);
					Vector3 point2 = new Vector3(cos * Radius2, capHeight, sin * Radius2);
					Vector3 point3 = new Vector3(cos2 * Radius1, 0, sin2 * Radius1);
					Vector3 point4 = new Vector3(cos2 * Radius2, capHeight, sin2 * Radius2);
